...
import com.sirocu.sipoint.function.TriConsumer;
import com.sirocu.sipoint.security.JwtConfiguration;
...
import static com.sirocu.sipoint.constant.Constants.*;
import static com.sirocu.sipoint.enums.TokenType.ACCESS;
import static com.sirocu.sipoint.enums.TokenType.REFRESH;
    ...
    private final TriConsumer<HttpServletResponse, User, TokenType> addCookie = (response, user, type) -> {
        switch (type) {
            case ACCESS -> {
                ...
                cookie.setPath("/");
                cookie.setAttribute("SameSite", NONE.name()); //Review the 'NONE' library
