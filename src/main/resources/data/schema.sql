...
CREATE TABLE IF NOT EXIST users (
    ...
    qr_code_secret CHARACTER VARYING(255) NOT NULL,
...
--    icon CHARACTER VARYING(255) NOT NULL, --6.36.00
--);
...
CREATE TABLE IF NOT EXISTS roles (
    ...
    CONSTRAINT fk_roles_created_by FOREIGN KEY (updated_by) REFERENCES users (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE
);
